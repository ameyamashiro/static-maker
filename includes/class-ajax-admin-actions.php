...
class Ajax_Admin_Actions
{
    ...
    public static function process_queue_all()
    {
        ...
        echo RsyncUtil::sync_with_current_options();

        wp_die();
    }

    public static function enqueue_single_by_id()
    {
        global $wpdb;
     ...
     * @deprecated
     */
    public static function fetch_single_html()
    {
    ...
    public static function add_pages_by_post_type()
    {
...
//                'post_title' => $post_type->post_title,
    ...
    public static function add_page_by_url()
    {
    ...
    public static function enqueue_all_pages()
    {
    ...
    public static function filter_remove_true($r)
    {
        $ret = false;
        foreach ($r as $e) {
            if (!$e) {
    ...
    public static function remove_page_from_list()
    {
    ...
    public static function change_page_status()
    {
